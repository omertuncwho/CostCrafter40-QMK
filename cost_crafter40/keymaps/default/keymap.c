...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_LAYER] = LAYOUT(
        ...
        KC_ESCAPE, KC_LGUI, KC_NO, LCTL_T(KC_TAB), LT(FUNCTION_LAYER, KC_SPACE), MO(1), KC_BACKSPACE, KC_LEFT_SHIFT,   KC_LALT, KC_ENTER),
    ...
    [FUNCTION_LAYER] = LAYOUT(
        ...
        KC_NO,        KC_NO,    KC_NO,    KC_NO,           MO(SHIFT_LAYER),   KC_NO,   KC_NO,   KC_BACKSLASH, KC_NO,    KC_NO),
    ...
    [SHIFT_LAYER] = LAYOUT(
        ...
        KC_NO,              KC_NO,          KC_NO,            KC_NO,                 KC_NO,                  MO(REBOOT_LAYER), KC_NO,      LSFT(KC_BACKSLASH), KC_NO,      KC_NO),
